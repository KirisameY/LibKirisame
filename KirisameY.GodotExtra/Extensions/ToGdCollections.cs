...
public static class ToGdCollections
{
    ...
    // Generic Dictionary
    public static Godot.Collections.Dictionary<TKey, TValue> ToGdDictionary<[MustBeVariant] TKey, [MustBeVariant] TValue>
        (this IEnumerable<KeyValuePair<TKey, TValue>> source)
    {
    ...
    public static Godot.Collections.Dictionary<TKey, TValue> ToGdDictionary<TSource, [MustBeVariant] TKey, [MustBeVariant] TValue>
    ...
    public static Godot.Collections.Dictionary<TKey, TSource> ToGdDictionary<[MustBeVariant] TSource, [MustBeVariant] TKey>
        (this IEnumerable<TSource> source, Func<TSource, TKey> keySelector)
    {
        var result = new Godot.Collections.Dictionary<TKey, TSource>();
